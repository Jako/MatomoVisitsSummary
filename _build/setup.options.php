...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install MatomoVisitsSummary</h2>

        <p>Thanks for installing MatomoVisitsSummary. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade MatomoVisitsSummary</h2>

        <p>MatomoVisitsSummary will be upgraded. This open source extra was
        <p>developed by Treehill Studio - MODX development in Münsterland.</p>
